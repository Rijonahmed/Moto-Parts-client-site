...
const BusinessSummary = () => {
  return (
    <div data-aos="fade-down "
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-5 max-w-7xl mx-auto mt-5 '>
        <div className="card card-compact max-w-max bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            <h2 className="card-title">We served <span className='text-orange-400'>100+</span> customers</h2>
        ...
        <div className="card card-compact max-w-max bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            <h2 className="card-title"><span className='text-orange-400'>99k</span> Annual Revenue</h2>
            <p>If a dog chews shoes whose shoes does he choose?</p>
            <div className="card-actions justify-end">
        ...
        <div className="card card-compact max-w-max bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            <h2 className="card-title"><span className='text-orange-400'>22K</span> Reviews</h2>
            <p>If a dog chews shoes whose shoes does he choose?</p>
            <div className="card-actions justify-end">
        ...
        <div className="card card-compact max-w-max bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            <h2 className="card-title"><span className='text-orange-400'>50+ </span> Parts</h2>
            <p>If a dog chews shoes whose shoes does he choose?</p>
            <div className="card-actions justify-end">
